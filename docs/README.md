...
| [`publications/`](publications/) | **Paper + decks** — the research & pitch track | The arXiv preprints + working drafts: "The Coordinator Trap" ([paper.md](publications/paper.md) / [arxiv/](publications/arxiv/)), the substrate-convergence paper ([paper2_…html](publications/paper2_substrate_convergence.html)); plus two decks — the architecture/strategy [presentation](publications/presentation.html) (engineer-facing) and the buyer-facing [customer pitch](publications/customer-pitch.html) (value/sovereignty-led). |
