...
| [`analysis/`](analysis/) | **Audit series** — the project's own report card | [`ratings.md`](analysis/ratings.md): the periodic 25-dimension M2 self-audit (execution-evidence-gated, with a calibration ledger that scores the scores). Run via the `mycelium-analysis` skill. Plus [`doc-coverage-2026-07-10.md`](analysis/doc-coverage-2026-07-10.md): the WHAT/WHY/HOW × Dev/Ops documentation-coverage audit (matrix + remediation; a re-run diff target). |
