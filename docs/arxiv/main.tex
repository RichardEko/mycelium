...
assembleable components. Its answer to environmental change was DevOps-scale: if
the runtime environment broke, re-resolve and redeploy at bundle granularity.
