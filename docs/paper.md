...
OSGi's insight was that software agility is a function of modular, dynamically assembleable components. Its answer to environmental change was to operate at DevOps scale: when the environment broke, a human rebuilt and redeployed at bundle granularity. Dynamic assembly was the goal; deploy-time resolution was where that ambition stopped.
