...
The MCB/P/S framework was introduced by the present author~\cite{nicholson2025}
as a three-axis evaluation of monetary architectures: Moral Circle Breadth, the
effective scope of those granted protection, voice, and material consideration;
Polycentricity, the dispersion, contestability, and recallability of decision
rights across multiple centres; and Surplus-Claim Regime, the incidence of
residual income and rents---who captures value after costs. The three axes
synthesise established traditions (the moral-circle literature after
Singer~\cite{singer1981}; Ostrom's~\cite{ostrom1990} polycentric governance; the
political economy of surplus and rent) into a single evaluative instrument. The
same three axes, we argue, capture the structural distinctions that the
Coordinator Trap Theorem implies a correct substrate must exhibit, and they do so
across all four HLKS domains. We summarise the generalisation here; a more detailed treatment
